...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_channels=3, embed_dim=768, ratio=1):
        super().__init__()
    ...
    def __init__(self, backbone, img_size=224, feature_size=None, in_channels=3, embed_dim=768):
        ...
        if feature_size is None:
            with torch.no_grad():
                ...
                if training:
                    backbone.eval()
                o = self.backbone(torch.zeros(1, in_channels, img_size[0], img_size[1]))[-1]
