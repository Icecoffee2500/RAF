...
uv run raf/experiments/train_hpe_cl.py --cfg raf/configs/hpe/mpii_mpii_mpii/vit-huge.yaml --pretrained ../pretrained/mae_pretrain_vit_huge.pth --wandb --gpu 7 --samples_per_client 12000 --train_bs 8 --test_bs 16 --loss_scale 1 --client_res max_high --kd_use

# CL - vit-h / 576x432 - no kd
uv run raf/experiments/train_hpe_cl.py --cfg raf/configs/hpe/coco/vit/vit_small_multi_res.yaml --pretrained ../pretrained/mae_pretrain_vit_small.pth --wandb --gpu 0 --samples_per_client 0 --train_bs 64 --test_bs 128 --client_res high